...
public class Index implements Runnable {
	...
	private void doDraw() {
		...
		playerRenderer.renderAt(player, player.getPosX(), player.getPosY(), 32, 64, player.getYaw());
		playerMovement();
	}
	
	private void playerMovement() {
		if (up && !down && player.getPosY() <= 510 - 64) {
		...
		} else if (right && !left && player.getPosX() <= 510 - 32) {
